...
import es.fabio.config.audit.AuditEventConverter;
import es.fabio.domain.PersistentAuditEvent;
...
import static es.fabio.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
